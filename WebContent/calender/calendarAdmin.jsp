...
/*         ,
        eventRender: function(event, element) {
        	if (event.id == "booked") {
        		element.find("a.fc-content").addClass('booked');
        	}
        } */
    });
...
$(function(){
	...
	$.ajax({
		...
		data : { currMonth: dateFormat().substring(0,7), 'campCode': campCode }, // viewData를 서버로 전송
		type : "post",
		traditional : true,
		success : function(res){
...
//			console.log("newViewData", viewData)
	...
	/* 캘린더 속성 중 id를 가져와 html에 직접 일정 요소에 클래스명 부여하기 */
